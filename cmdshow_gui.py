...
class App:
    ...
    def generateSlideshow(self):
        ...
        if check == True:
            ...
            createSlideshow(self.imageDir, self.audio, self.frameDuration, self.framerate, self.resolution, self.transitionDuration, self.transitionType, self.outputDir)
    ...
    def chooseAudio(self):
        self.audio = filedialog.askopenfile(mode ='r', filetypes =[('Audio Files', '*.wav')]).name
